...
const SHOP_CONFIG = {
  ...
  stripeLinks: {
    ...
    "haec-toddler-tee": "https://buy.stripe.com/eVqeVd88R0h8edVaI9frW0o",
...
const PRODUCTS = [
  ...
  { id: "afro-woman", name: "Afro Woman Laser-Cut Wall Art", price: 45, cat: "Wood Art",
    ...
    blurb: "Intricately laser-cut wall art, 20″ × 36″ — a striking statement piece." },
  { id: "tree-woman", name: "Tree Woman Laser-Cut Wall Art", price: 45, cat: "Wood Art",
    img: "assets/img/shop-tree-woman.webp", options: "MDF or Original Wood Finish",
    blurb: "Precision laser-cut décor, 20″ × 36″, with beautiful, delicate detail." },
  { id: "in-love-couple", name: "In-Love Couple Laser-Cut Wall Art", price: 45, cat: "Wood Art",
    img: "assets/img/shop-in-love-couple.webp", options: "MDF or Original Wood Finish",
    blurb: "A romantic laser-cut piece, 20″ × 36″ — perfect for the home or as a gift." },
  ...
  { id: "haec-tshirt-youth", name: "H.A.E.C T-Shirt_Youth", price: 16.95, cat: "Education",
    img: "assets/img/shop-haec-tshirt-youth.webp?v=3", options: "Youth XS–XL",
  ...
  { id: "haec-toddler-tee", name: "H.A.E.C Toddler T-Shirt", price: 14.95, cat: "Education",
...
const VARIANTS = {
  ...
  "mom-life":          { colors: ["White","Tan"], sizes: SZ_ADULT_XS, garments: ["Hoodie","Sweatshirt"], flat: 28.95, bulk: true },
  "pray-on-it-hoodie": { colors: ["Brown","Gray","White"], sizes: SZ_ADULT_XS, garments: ["Hoodie","Sweatshirt"], flat: 28.95, bulk: true },
  "pray-on-it-tee":    { colors: ["Black","White"], sizes: SZ_ADULT_XS, garments: ["Short Sleeve","Long Sleeve"], flat: 19.95, bulk: true },
  "pray-pray-pray":    { colors: ["Black","Brown","Natural","Blue","Gray","White"], sizes: SZ_ADULT_XS, garments: ["Hoodie","Sweatshirt"], flat: 28.95, bulk: true },
  "waymaker":          { colors: ["Black","Brown","Natural","Blue","Gray","White"], sizes: SZ_ADULT_XS, garments: ["Hoodie","Sweatshirt"], flat: 28.95, bulk: true },
  "know-your-worth":   { colors: ["White","Pink","Natural"], sizes: SZ_ADULT_XS, garment: "T-Shirt", flat: 19.95, bulk: true },
  "jesus-forgives":    { colors: ["White"], sizes: SZ_ADULT_XS, garment: "T-Shirt", bulk: true },
  "his-timing":        { colors: ["White","Blue","Black"], sizes: SZ_ADULT_XS, garment: "T-Shirt", flat: 19.95, bulk: true },
  "classy-hoodrat":    { colors: ["White"], sizes: SZ_ADULT_XS, garment: "T-Shirt", flat: 19.95, bulk: true },
  ...
  "haec-toddler-tee":  { colors: ["White","Natural","Black"], sizes: SZ_TODDLER, garment: "T-Shirt", age: "Youth", flat: 14.95, bulk: true },
